...
export interface TableBuilder {
   ...
   * Outer bind
   */
  setSortFunction(f: Function): TableBuilder;
  setSearchFunction(f: Function): TableBuilder;
}
...
export interface Table {
  ...
  /**
   * Outer sort function setter
   */
  setSort(sort: Function): void;
  /**
   * Outer search function setter
   */
  setSearch(sort: Function): void;
}
...
export interface ColumnBuilder extends BasicColumnBuilder {
   ...
   */
  setEditable(
    isEditable?: boolean | ((target: any) => boolean),
   ...
   *
   */
  setFilter(filterType: any, options?: any[]): ColumnBuilder;
}
